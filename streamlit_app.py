...
[경력 및 스킬]
- 주무기: Python, Streamlit, JavaScript
- 보조기: HTML, SCSS 
- 주요 프로젝트: 삼성 갤럭시캠퍼스 이벤트페이지(1년 6개월), 굿웨어몰 기획전(2개월), 코오롱 기획전(2개월), 아모레퍼시픽 운영 및 기획전(2년)
